...
interface ConsumerStrategy {
    ...
    fun serialize(source: TimetableContext): String
    fun deserialize(value: String, target: TimetableContext)
}

class AppKafkaConsumer(
    private val config: AppKafkaConfig,
    consumerStrategies: List<ConsumerStrategy>,
    private val processor: TimetableTripProcessor = TimetableTripProcessor(),
    ...
    private fun sendResponse(context: TimetableContext, strategy: ConsumerStrategy, outputTopic: String) {
